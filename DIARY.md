...
- 오늘 한일
  ...
  - 🐬 수빈 : groupLeader 데이터 서버와 동기화
  - 👀 소민 : 예외처리(회원정보관련)
  - 💪 승훈 : API연결이어서 진행, 누나가 필요한 API기능 추가

- 다음회차까지 할일

  - 🐬 수빈 : groupLeader 데이터 서버와 동기화, 그룹장페이지 라우터 연결
  - 👀 소민 : 달력데이터가공 / 모달 진행상황 변경되게 하기/ 예외처리(회원정보관련)+수정부분 + 마무리조금더
  - 💪 승훈 : 그룹 리스트 카테고리 추가, 로그인상태 인증 처리

- 장애사항 및 tmi

  - 🐬 수빈 : 내일은 좀 더 많이....
  - 👀 소민 : 내일 좀 힘들어서 모달만하고 싶다.고a
  - 💪 승훈 : :smile::smile::smile:
